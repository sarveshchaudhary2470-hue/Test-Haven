        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-gray-900 pt-16">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* Left Column - Tests & Results (Main Work) */}
                    ...
                    {/* Right Column - Updates, Materials, Events (Sidebar) */}
                    <div className="space-y-6">
                        ...
                        {superContests.length > 0 && (
                            <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ delay: 0.4 }}
                                className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 backdrop-blur-xl border border-yellow-500/30 rounded-3xl p-6 shadow-xl"
                            >
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400 text-xs">Compete and win!</p>
                                    </div>
                                </div>
                                    ...
                                    {superContests.map((contest, index) => {
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                animate={{ opacity: 1, scale: 1 }}
                                                transition={{ delay: index * 0.1 }}
                                                className="relative bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-2xl p-4 hover:border-yellow-500/50 hover:shadow-xl hover:shadow-yellow-500/20 transition-all group"
                                            >
                                                {/* Status Badge */}
                                                <div className="absolute top-2 right-2">
                                                    {isLive ? (
                                                        <span className="px-2 py-0.5 bg-gradient-to-r from-green-500 to-emerald-500 text-white text-[10px] font-bold rounded-full shadow-lg animate-pulse">
                                                            LIVE
                                                        </span>
                                                    ) : isUpcoming ? (
                                                        <span className="px-2 py-0.5 bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-[10px] font-bold rounded-full shadow-lg">
                                                            UPCOMING
                                                        </span>
                                                    ) : (
                                                        <span className="px-2 py-0.5 bg-gray-500/50 text-gray-300 text-[10px] font-bold rounded-full">
                                                            ENDED
                                                        </span>
                                                    )}
                                                </div>
                                                ...
                                                <div className="mb-2">
                                                    ...
                                                    <p className="text-gray-400 text-xs">{contest.subject}</p>
                                                </div>

                                                <div className="space-y-1 mb-3">
                                                    <div className="flex items-center gap-2 text-xs text-gray-300">
                                                        <Clock className="h-3 w-3 text-blue-400" />
                                                        <span>{contest.duration}m • {contest.totalMarks} marks</span>
                                                    </div>
                                                    <div className="flex items-center gap-2 text-xs text-gray-300">
                                                ...
                                                {isLive && (
                                                    <button
                                                        ...
                                                        className="w-full py-2 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white text-sm font-bold rounded-lg shadow-lg shadow-yellow-500/30 transition-all hover:shadow-xl hover:shadow-yellow-500/40 transform active:scale-95"
                                                    >
                                                        Join Now
                                                    </button>
                                                )}
